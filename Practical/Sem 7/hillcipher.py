...
def make_key():
    ...
    while True:
        ...
        if inverse_element == 0:
            ...
            print("a-z characters are accepted")
...
if __name__ == "__main__":
    print("Implement Hill Cipher :")
    msg = input("The Message is: ")
    encrypted_msg = encrypt(msg)
    print("The Encrypted text is :" ,encrypted_msg)
    decrypted_msg = decrypt(encrypted_msg)
    print("The Decrypted Text is :",decrypted_msg)